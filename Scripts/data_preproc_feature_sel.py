...
class UKStockAnalyzer:
    ...
    def __init__(self, tickers=None, start_date="2015-01-01",end_date="2025-06-01"):
        """
    ...
    def fetch_macroeconomic_data(self):
        ...
        try:
            cpi_raw = pd.read_csv('C:/Users/sheri/Downloads/Causal_Inference_Project/Data/cpih01-time-series-v57.csv')
        ...
        try:
            ...
            rate_df = pd.read_csv('C:/Users/sheri/Downloads/Causal_Inference_Project/Data/Bank_Rate_history_and_data_ Bank_of_England_Database.csv')
            # Rename columns
        ...
        try:
            ...
            df = pd.read_csv("C:/Users/sheri/Downloads/Causal_Inference_Project/Data/Unemployment_series-180525.csv", skiprows=8)
